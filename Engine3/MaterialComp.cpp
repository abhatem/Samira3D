...
#include "Globals.h"
void MaterialComp::init(SceneObject * obj)
{
	lamp->setColor(glm::vec3(1.0f, 1.0f, 1.0f));
}

void MaterialComp::update(SceneObject * obj)
{
}

void MaterialComp::render(SceneObject * obj, CameraAbstract* cam, bool lightRender)
{
	if (!lightRender) {
		shader->use();
...
void MaterialComp::release(SceneObject * obj)
{
}
