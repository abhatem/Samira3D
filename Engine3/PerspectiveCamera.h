...
class PerspectiveCamera : public CameraAbstract
{
public:
	PerspectiveCamera();
	//PerspectiveCamera(RenderTarget *renderTexture);
	...
	void setProjection(float fieldOfView, float aspect, float zNear, float zFar);
